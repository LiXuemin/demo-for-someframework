package com.lixuemin.privilege;
...
public class PrivilegeService {
    ...
    public static void main(String[] args) {
        ...
        List<Class<?>> classes = privilegeService.initControllerClass();
        classes.stream().map(c -> c.getName()).forEach(System.out::println);
    }

    private List<Class<?>> initControllerClass() {
        Set<Class<?>> classSet = new HashSet<Class<?>>();
        classSet.addAll(getClasses("com.lixuemin"));
        //过滤出所有的controller
